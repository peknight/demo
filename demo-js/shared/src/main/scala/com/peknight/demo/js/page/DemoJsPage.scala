...
class DemoJsPage[Builder, Output <: FragT, FragT](val bundle: Bundle[Builder, Output, FragT]):
  ...
  val index: Frag = skeleton("Scala.JS Demo Home")(
    ...
    p(a(href := "/node_append_child")("Node Append Child Demo")),
    p(a(href := "/node_on_mouse_move")("Node On Mouse Move Demo")),
    p(a(href := "/dom_btoa")("BTOA Demo")),
    p(a(href := "/dom_local_storage")("Local Storage Demo")),
    p(a(href := "/dom_html_canvas_element")("HTML Canvas Element Demo")),
    p(a(href := "/dom_fetch")("Dom Fetch Demo")),
    p(a(href := "/dom_websocket")("Websocket Demo")),
    p(a(href := "/element_style")("Element Style Demo")),
    h2("Lihaoyi Canvas"),
    p(a(href := "/hands_on_canvas")("Canvas Tutorial Demo")),
    p(a(href := "/sierpinski_triangle")("Sierpinski Triangle Demo")),
    p(a(href := "/space_invaders")("Space Invaders Demo")),
    p(a(href := "/dodge_the_dots")("Dodge The Dots Demo")),
    p(a(href := "/sketchpad")("Sketchpad Demo")),
    p(a(href := "/canvas_clock")("Canvas Clock Demo")),
    p(a(href := "/flappy_box")("Flappy Box Demo")),
    p(a(href := "/canvas_async_advanced")("Async Advanced Demo")),
    h2("Lihaoyi Webpage"),
    p(a(href := "/hello_world_0")("Hello World 0 Demo")),
    p(a(href := "/hello_world_1")("Hello World 1 Demo")),
    p(a(href := "/capital_box")("Capital Box Demo")),
    p(a(href := "/re_rendering")("Re Rendering Demo")),
    p(a(href := "/weather_1")("Weather 1 Demo")),
    p(a(href := "/weather_search")("Weather Search Demo")),
    p(a(href := "/future_weather")("Future Weather Demo"))
  )

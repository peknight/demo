...
```
> fastLinkJS
[info] Fast optimizing (...)/scalajs-tutorial/target/scala-3.6.2/scala-js-tutorial-fastopt
[success] (...)
```
...
```
> fullLinkJS
[info] Full optimizing (...)/scalajs-tutorial/target/scala-3.6.2/scala-js-tutorial-opt

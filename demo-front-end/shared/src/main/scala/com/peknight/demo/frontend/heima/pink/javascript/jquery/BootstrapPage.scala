...
class BootstrapPage[Builder, Output <: FragT, FragT](override val bundle: Bundle[Builder, Output, FragT])
  ...
  override def links: Seq[String] = Seq("/webjars/bootstrap/5.2.3/dist/css/bootstrap.min.css")
  override def scripts: Seq[String] = Seq("/webjars/bootstrap/5.2.3/dist/js/bootstrap.bundle.min.js")

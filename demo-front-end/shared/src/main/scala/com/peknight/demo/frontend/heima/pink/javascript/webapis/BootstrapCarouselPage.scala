...
class BootstrapCarouselPage[Builder, Output <: FragT, FragT](override val bundle: Bundle[Builder, Output, FragT])
  ...
  override protected def links: Seq[String] = Seq("/webjars/bootstrap/5.2.2/dist/css/bootstrap.min.css")
  override def styles: Seq[StyleSheet.Base] = Seq(Styles)
  override protected def scripts: Seq[String] = Seq("/webjars/bootstrap/5.2.2/dist/js/bootstrap.bundle.min.js")
  override def headTitle: String = "bootstrap轮播图"
  override def javaScriptMethod: Option[String] = Some("bootstrapCarousel")
  private[this] val focusId: String = "focus-carousel"
  override def bodyFrag = div(cls := "focus")(
    div(id := focusId, cls := "carousel slide", attr("data-bs-ride") := "carousel")(

  ...
  val index: Frag =
    html(lang := "zh-CN")(
      head(
        ...
        title("阿里百秀"),
        link(href := "/webjars/bootstrap/5.3.6/dist/css/bootstrap.min.css", rel := "stylesheet"),
        link(href := "/webjars/bootstrap-icons/1.12.1/font/bootstrap-icons.css", rel := "stylesheet"),
        style(raw(AlibaixiuMediaStyles.render[String])),
        style(raw(AlibaixiuStyles.render[String])),
        script(src := "/webjars/bootstrap/5.3.6/dist/js/bootstrap.bundle.min.js"),
      ),
      body(
        div(cls := "container")(
          div(cls := "row")(

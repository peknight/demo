...
abstract class EChartsPage[Builder, Output <: FragT, FragT](val bundle: Bundle[Builder, Output, FragT]):
  ...
  def index: Frag =
    html(lang := "zh-CN")(
      head(
        ...
        script(`type` := "text/javascript", src := "/webjars/echarts/5.4.2/dist/echarts.min.js"),

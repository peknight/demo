...
trait BarItemStyleOption[TCbParams] extends ItemStyleOption[TCbParams]:
  val borderRadius: js.UndefOr[Number | js.Array[Number]] = js.undefined

object BarItemStyleOption:
  def apply[TCbParams](shadowBlur: js.UndefOr[Number] = js.undefined,
    ...
    new BarItemStyleOption[TCbParams]:

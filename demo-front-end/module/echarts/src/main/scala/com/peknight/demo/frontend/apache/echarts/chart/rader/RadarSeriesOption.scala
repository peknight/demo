...
trait RadarSeriesOption extends RadarSeriesOptionInner with SeriesInjectedOption
object RadarSeriesOption:
  def apply(id: js.UndefOr[OptionId] = js.undefined,
            ...
            emphasis: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & DefaultStatesMixinEmphasis & StatesEmphasisOptionMixin] = js.undefined,
            select: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any & StatesSelectOptionMixin] = js.undefined,
            blur: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any] = js.undefined,
            ...
            data: js.UndefOr[js.Array[RadarSeriesDataItemOption | RadarSeriesDataValue]] = js.undefined,
            ...
            coordinateSystem: js.UndefOr["radar"] = js.undefined,
            ...
            areaStyle: js.UndefOr[AreaStyleOption[ZRColor]] = js.undefined,
            ...
            radarIndex: js.UndefOr[Number] = js.undefined,
            radarId: js.UndefOr[String] = js.undefined,
            ...
            tooltip: js.UndefOr[SeriesTooltipOption] = js.undefined): RadarSeriesOption =
    ...
    val _emphasis: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & DefaultStatesMixinEmphasis & StatesEmphasisOptionMixin] = emphasis
    val _select: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any & StatesSelectOptionMixin] = select
    val _blur: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any] = blur
    ...
    val _data: js.UndefOr[js.Array[RadarSeriesDataItemOption | RadarSeriesDataValue]] = data
    ...
    val _coordinateSystem: js.UndefOr["radar"] = coordinateSystem
    ...
    val _areaStyle: js.UndefOr[AreaStyleOption[ZRColor]] = areaStyle
    ...
    val _radarIndex: js.UndefOr[Number] = radarIndex
    val _radarId: js.UndefOr[String] = radarId
    ...
    new RadarSeriesOption:
      override val mainType: js.UndefOr[MainType] = "series"
      override val `type`: js.UndefOr[Type] = "radar"
      ...
      override val emphasis: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & DefaultStatesMixinEmphasis & StatesEmphasisOptionMixin] = _emphasis
      override val select: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any & StatesSelectOptionMixin] = _select
      override val blur: js.UndefOr[RadarSeriesStateOption[CallbackDataParams] & js.Any] = _blur
      ...
      override val areaStyle: js.UndefOr[AreaStyleOption[ZRColor]] = _areaStyle
      ...
      override val radarIndex: js.UndefOr[Number] = _radarIndex
      override val radarId: js.UndefOr[String] = _radarId

...
trait EChartsOption extends ECBasicOption:
  ...
  val series: js.UndefOr[SeriesOption$1 | js.Array[SeriesOption$1]] = js.undefined
...
object EChartsOption:
  def apply(title: js.UndefOr[TitleOption | js.Array[TitleOption]] = js.undefined,
            ...
            series: js.UndefOr[SeriesOption$1 | js.Array[SeriesOption$1]] = js.undefined): EChartsOption =
    val _title = title
    val _xAxis = xAxis
    val _yAxis = yAxis
    ...
    new EChartsOption {
      ...
      override val series: js.UndefOr[SeriesOption$1 | js.Array[SeriesOption$1]] = _series
    }
